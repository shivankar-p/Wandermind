...
export const Avatar = () => {
    ...
    const [mySpeechText, setMySpeechText] = useState("This is dummy speech ok".repeat(5));
    ...
    const startSession = () => {
        ...
        console.log("avatar syn init");
        setAvatarSynthesizer(avatarSynthesizer);

        console.log("avatar synth set");
